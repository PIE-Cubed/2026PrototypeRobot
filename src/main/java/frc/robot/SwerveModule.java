...
public class SwerveModule {
    ...
    public SwerveModule(int driveID, int rotateID, boolean invertDriveMotor) {
        ...
        rotateMotorConfig.smartCurrentLimit(ROTATE_MOTOR_CURRENT_LIMIT).idleMode(IdleMode.kBrake);
        ...
        absoluteEncoderConfig.positionConversionFactor(ROTATE_ENCODER_CONVERSION).inverted(true);
        ...
        rotateMotor.configure(rotateMotorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
    ...
    public REVLibError setDriveCurrentLimit(int currentLimit) {
        ...
        return driveMotor.configure(driveMotorConfig, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
    }
